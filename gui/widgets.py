    ...
    def __init__(self, master, **kwargs):
        ...
        for b_row, b_col in product(range(3), range(3)):
            ...
            for r, c in product(range(3), range(3)):
                ...
                cell.bind("<Up>", lambda event, r=actual_row, c=actula_col: self.move_focus(r - 1, c))
                cell.bind("<Down>", lambda event, r=actual_row, c=actula_col: self.move_focus(r + 1, c))
                cell.bind("<Left>", lambda event, r=actual_row, c=actula_col: self.move_focus(r, c - 1))
                cell.bind("<Right>", lambda event, r=actual_row, c=actula_col: self.move_focus(r, c + 1))
